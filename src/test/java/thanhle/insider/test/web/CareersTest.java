...
public class CareersTest extends BaseTest {
	...
	@Test
	public void TC20001() throws InterruptedException {
		ExtentReportListener.logInfo("1. Visit https://useinsider.com/ and check Insider home page is opened or not");
		HomePage homePage = new HomePage();
		homePage.acceptCookies();		
		assertTrue(homePage.isDisplayed(), "Home page is not displayed.");
		
		ExtentReportListener.logInfo("2. Select the “Company” menu in the navigation bar, select “Careers” and check Career page, its Locations, Teams, and Life at Insider blocks are open or not");
		...
		ExtentReportListener.logInfo("3. Go to https://useinsider.com/careers/quality-assurance/, click “See all QA jobs”, filter jobs by Location: “Istanbul, Turkey”, and Department: “Quality Assurance”, check the presence of the job list");
		CareersTeamPage qualityAssurancePage = new CareersTeamPage("https://useinsider.com/careers/quality-assurance/");
		
		String location = "Istanbul, Turkey";//iye
		...
		ExtentReportListener.logInfo("4. Check that all jobs’ Position contains “Quality Assurance”, Department contains “Quality Assurance”, and Location contains “Istanbul, Turkey”");
		for (Job job : jobs) {
		...
		ExtentReportListener.logInfo("5. Click the “View Role” button and check that this action redirects us to the Lever Application form page");
